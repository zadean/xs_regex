-file("c:/Program Files/erl10.0/lib/parsetools-2.1.7/include/leexinc.hrl", 0).
...
-module(xs_regex_scanner).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("../src/xs_regex_scanner.xrl", 147).

-file("c:/Program Files/erl10.0/lib/parsetools-2.1.7/include/leexinc.hrl", 14).
...
-file("../src/xs_regex_scanner.erl", 307).
yystate() -> 62.
